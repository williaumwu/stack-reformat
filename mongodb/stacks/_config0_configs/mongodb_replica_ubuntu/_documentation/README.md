...
| mongodb_hosts      | the hostnames for he mongodb_hosts in the replica set separated by a comma| string   | None     |
...
| aws_default_region | aws region to create the ecr repo                                         | string   | None     |
...
| vm_username               | The username for the VM. e.g. ec2 for AWS linux              | string   | ubuntu                             |
...
| mongodb_version           | the version for mongodb                                      | string   | 4.2                                |
...
| publish_to_saas           | help-add-description-2023                                    |          | null                               |
...
| terraform_docker_exec_env | the docker container for terraform execution                 | string   | elasticdev/terraform-run-env:1.3.7 |
| ansible_docker_exec_env   | the docker container for ansible execution                   | string   | elasticdev/ansible-run-env         |
| cloud_tags_hash           | help-add-description-2023                                    |          | null                               |
